...
#[no_mangle]
pub extern "C" fn frexp(x: f64) -> F64I32 {
    let (a, b) = libm::frexp(x);
    F64I32 { a, b }
}

#[no_mangle]
pub extern "C" fn frexpf(x: f32) -> F32I32 {
...
#[no_mangle]
pub extern "C" fn lgamma_r(x: f64) -> F64I32 {
...
#[no_mangle]
pub extern "C" fn lgammaf_r(x: f32) -> F32I32 {
...
#[no_mangle]
pub extern "C" fn modf(x: f64) -> F64F64 {
    let (a, b) = libm::modf(x);
    F64F64 { a, b }
}

#[no_mangle]
pub extern "C" fn modff(x: f32) -> F32F32 {
...
#[no_mangle]
pub extern "C" fn remquo(x: f64, y: f64) -> F64I32 {
    let (a, b) = libm::remquo(x, y);
    F64I32 { a, b }
}

#[no_mangle]
pub extern "C" fn remquof(x: f32, y: f32) -> F32I32 {
...
#[no_mangle]
pub extern "C" fn sincos(x: f64) -> F64F64 {
    let (a, b) = libm::sincos(x);
    F64F64 { a, b }
}

#[no_mangle]
pub extern "C" fn sincosf(x: f32) -> F32F32 {
